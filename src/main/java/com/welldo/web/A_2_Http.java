...
/**
 * web 基础
 * 关于HTTP协议的详细内容，请参考Mozilla开发者网站。 https://developer.mozilla.org/zh-CN/docs/Web/HTTP
 *
 * 0. 如今，我们访问网站，使用App时，都是基于Web这种Browser/Server模式，简称BS架构
 *
 * 1.HTTP协议
 * 在Web应用中，浏览器请求（发送）一个URL，服务器就把生成的HTML网页发送给浏览器，而浏览器和服务器之间的传输协议是HTTP，所以：
 *      HTML是一种用来定义网页的文本
 *      HTTP是在网络上传输HTML的协议，用于浏览器和服务器的通信。
 * HTTP协议是一个基于TCP协议之上的"请求-响应协议"，它非常简单
 *
 *
 * 1.1 HTTP协议运行在TCP之上，所有传输的内容都是明文，
