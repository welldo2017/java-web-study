 ...
 *
 * 4. 类似Tomcat这样的服务器也是Java编写的，
 * 启动Tomcat服务器实际上是启动Java虚拟机，执行Tomcat的main()方法，然后由Tomcat负责加载我们的.war文件，
 * 并创建war包中编写的 Servlet 实例，最后以多线程的模式来处理HTTP请求。
...
public class Servlet4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (name == null || name.length()== 0) {
            pw.write("<h1>Hello, web-world!  by 张三 </h1>");
        }else {
