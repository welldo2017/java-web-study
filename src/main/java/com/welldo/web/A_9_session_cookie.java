 ...
 * 要解决这个问题，
 * 方案1: 在所有Web Server之间进行Session复制，但这样会严重消耗网络带宽，并且，每个Web Server的内存均存储所有用户的Session，内存使用率很低。
 ...
 * 对于大型Web应用程序来说，通常需要避免使用Session机制。{@link A_9_session_cookie_4}
 *
 * author:welldo
...
public class A_9_session_cookie extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        pw.write("<form action=\"/signin\" method=\"post\">");//POST请求/signin
